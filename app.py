...
with col1:
    ...
    gender = 1 if gender_label == "Male" else 0  # LabelEncoder: Female=0, Male=1

    school_label = st.selectbox("School Type", ["Public", "Private"])
    school_type = 1 if school_label == "Public" else 0  # LabelEncoder: Private=0, Public=1
...
if predict_btn:
    ...
    # Step 1 — Scale numeric features using saved scaler (matches notebook exactly)
...
with col_f3:
    st.caption("🤖 AI & Data Science Project | 2025") = min(int(50 + abs(prediction - 50)), 99)
